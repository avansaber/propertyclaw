...
Property management for [ERPClaw](https://github.com/avansaber/erpclaw). <!-- SYNC:value:group.propertyclaw.module_count -->2<!-- /SYNC --> modules covering residential and commercial real estate. <!-- SYNC:value:group.propertyclaw.total_actions -->132<!-- /SYNC --> actions total with real double-entry GL, trust accounting, and compliance features.

## Modules

### Residential (`propertyclaw`)
Property management for US landlords (20-500 units). <!-- SYNC:value:module.propertyclaw.actions -->102<!-- /SYNC --> actions across 5 domains -- properties, leases, tenants, maintenance, and trust accounting. FCRA-compliant screening, state-specific late fees, and 1099 reporting.
