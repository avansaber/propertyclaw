...
register_prefix("propertyclaw_property", "PROP-")
register_prefix("propertyclaw_unit", "PUNIT-")
register_prefix("propertyclaw_application", "PAPP-")
register_prefix("propertyclaw_lease", "PLSE-")
register_prefix("propertyclaw_work_order", "PWO-")
register_prefix("propertyclaw_inspection", "PINSP-")
register_prefix("propertyclaw_owner_statement", "PSTMT-")
...
def main():
    parser = SafeArgumentParser(description="propertyclaw")
    ...
    # F19b: security-deposit GL account overrides
    parser.add_argument("--cash-account-id")
    parser.add_argument("--deposit-liability-account-id")
    parser.add_argument("--income-account-id")
    ...
    if _dep:
        _dep["suggestion"] = "clawhub install erpclaw && clawhub install propertyclaw"
