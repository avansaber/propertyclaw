"""Shared pytest fixtures for PropertyClaw Commercial unit tests."""
import os
import sys
...
import pytest
from commercial_helpers import init_all_tables, get_conn, build_env
...
@pytest.fixture
def env(conn):
    """Full commercial test environment: company, naming series, fiscal year."""
